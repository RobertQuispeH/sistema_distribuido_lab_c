...
class ProyectoGUI:
    def __init__(self, root):
        ...
        self.label_proyectos.grid(row=0, column=0, padx=10, pady=10, columnspan=2)

        self.proyectos_listbox = tk.Listbox(root, width=120, height=10)
        self.proyectos_listbox.grid(row=1, column=0, padx=10, pady=10, rowspan=6, columnspan=3)
